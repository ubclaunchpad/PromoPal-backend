...
describe('Unit tests for DiscountRepository', function () {
    ...
    test('Should not be able to create discount without promotion', () => __awaiter(this, void 0, void 0, function* () {
        const discount = new DiscountFactory_1.DiscountFactory().generate();
        try {
            yield discountRepository.save(discount);
...
//# sourceMappingURL=DiscountRepository.test.js.map